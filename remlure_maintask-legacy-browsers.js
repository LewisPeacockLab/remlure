...
function Encode_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    Encode_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Oper_screen_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    Oper_screen_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Operations_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    Operations_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Probe_screen_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    Probe_screen_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Probe_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    Probe_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Practice_beginRoutineBegin(snapshot) {
  return async function () {
    ...
    Practice_beginComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Trial_prepareRoutineBegin(snapshot) {
  return async function () {
    ...
    Trial_prepareComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Delay_2000RoutineBegin(snapshot) {
  return async function () {
    ...
    Delay_2000Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ManipulateRoutineBegin(snapshot) {
  return async function () {
    ...
    ManipulateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Delay_4000RoutineBegin(snapshot) {
  return async function () {
    ...
    Delay_4000Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Main_exp_beginRoutineBegin(snapshot) {
  return async function () {
    ...
    Main_exp_beginComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
